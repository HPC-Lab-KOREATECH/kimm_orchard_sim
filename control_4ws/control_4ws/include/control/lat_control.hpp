...
public:
    ...
    linear_angular calc_combined_steer()
    {
        ...
        this->combined_steer.linear = low_pass_filter(this->combined_steer.linear, this->pre_linear, alpha);
        this->combined_steer.angular = low_pass_filter(this->combined_steer.angular, this->pre_angular, alpha);
        this->pre_linear = combined_steer.linear;
        this->pre_angular = combined_steer.angular;
